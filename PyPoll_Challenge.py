...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (county_vote_count > largest_turnout_votes) and (county_vote_percentage > largest_turnout_percentage):
    ...
    largest_turnout_county_result = (
        f"\n-------------------------\n"
        f"Largest county turnout: {largest_turnout_county}\n"
        f"-------------------------\n")
        
    print(largest_turnout_county_result)
